//filterBy, the first param will be the filtering property (genre, author, or publisher), the
//second will be the string that is being searched. You must return all books that match
//the condition.
